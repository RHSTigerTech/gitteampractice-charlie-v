...
public class Classroom {
        ...
        public Classroom() {
                ...
                CrockettsClassroom[1][2] = new Place("Empty desk",
                                "An empty desk facing the back of the classroom. How engaging.");
                CrockettsClassroom[1][3] = new Place("Empty desk",
                                "An empty desk facing the back of the classroom. How engaging.");
                ...
                CrockettsClassroom[3][0] = new Place("Empty desk", "An empty desk.");
                ...
                CrockettsClassroom[5][0] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[5][1] = new Place("Empty desk", "An empty desk.");
                ...
                CrockettsClassroom[7][1] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[7][2] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[7][3] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[7][9] = new Place("Empty desk", "An empty desk.");

                CrockettsClassroom[8][0] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[8][1] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[8][2] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[8][3] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[8][9] = new Place("Empty desk", "An empty desk.");

                CrockettsClassroom[9][6] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[9][7] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[9][8] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[9][9] = new Place("Printer", "A printer, used to print things.");

                CrockettsClassroom[10][0] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[10][1] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[10][2] = new Place("Empty desk", "An empty desk.");
                CrockettsClassroom[10][3] = new Place("Empty desk", "An empty desk.");
